...
webpage <- read_html("https://electionresults.sos.mn.gov/Results/Index?ersElectionId=157&scenario=ResultsByPrecinctCrosstab&OfficeInElectionId=33127&QuestionId=0")
...
write.csv(table_content, "data/SB_D3_map.csv", row.names = FALSE)