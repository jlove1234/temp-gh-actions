...
webpage <- read_html("https://electionresults.sos.mn.gov/Results/Index?ersElectionId=157&scenario=ResultsByPrecinctCrosstab&OfficeInElectionId=33124&QuestionId=0.R")
...
write.csv(table_content, "data/city_district5_map.csv", row.names = FALSE)