...
webpage <- read_html("https://electionresults.sos.mn.gov/Results/Index?ersElectionId=157&scenario=ResultsByPrecinctCrosstab&OfficeInElectionId=33123&QuestionId=0")
...
write.csv(table_content, "data/city_district4_map.csv", row.names = FALSE)